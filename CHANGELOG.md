...
- 0.1.0-rc.2 release-candidate snapshot: retain the host-neutral canonical skill, deterministic four-client package definitions, static validators, and transaction-safe local build pipeline.
